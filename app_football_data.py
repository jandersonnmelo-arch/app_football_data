...
# ==============================
# 🏆 MÉDIAS DAS LIGAS - COM TODOS OS ITENS
# ==============================
MEDIAS_LIGA = {
    "BSA": {"esc":9.0,"cartao":3.2,"fin":9.5,"chute_gol":4.0,"fal":26.5,"defesa_gk":4.2,"gols":2.6,
            ...
            "mais65esc":78,"mais75esc":69,"mais85esc":58,"mais95esc":45,"mais105esc":38,"mais115esc":30,"mais125esc":22,
    ...
    "WC": {"esc":8.2,"cartao":3.0,"fin":10.0,"chute_gol":4.2,"fal":25.0,"defesa_gk":4.0,"gols":2.5,
           "tiro_meta":4.5,"laterais":8.0,"imped":2.8,
           "vit_casa":42,"vit_fora":32,"empate":26,
           "mais15":74,"menos15":26,"mais25":53,"menos25":47,"menos35":80,"mais35gols":36,
           "mais15cartao":93,"mais25cartao":70,"mais35cartao":48,"mais65cartao":24,
           "mais65esc":76,"mais75esc":67,"mais85esc":56,"mais95esc":44,"mais105esc":37,"mais115esc":29,"mais125esc":21,
           "mais25imp":76,"mais35imp":60,
           "mais305lat":66,"mais325lat":53,"mais345lat":40,"mais365lat":26,
           "mais55tm":70,"mais65tm":58,"mais75tm":46,"mais95tm":28,
           "mais195fin":66,"mais205fin":58,"mais225fin":43,"mais255fin":23,
           "mais65cg":68,"mais75cg":53,"mais85cg":38,"mais95cg":44,
           "mais195fal":76,"mais225fal":60,"mais255fal":46,"mais295fal":30,
           "mais25def":78,"mais35def":52,"mais45def":36,"mais55def":28},
    "CL": {"esc":9.5,"cartao":2.7,"fin":11.0,"chute_gol":4.8,"fal":23.5,"defesa_gk":3.5,"gols":2.9,
           ...
           "mais65esc":80,"mais75esc":72,"mais85esc":62,"mais95esc":50,"mais105esc":42,"mais115esc":34,"mais125esc":26,
    ...
    "EC": {"esc":8.8,"cartao":2.9,"fin":10.5,"chute_gol":4.5,"fal":24.0,"defesa_gk":3.8,"gols":2.7,
           ...
           "mais65esc":78,"mais75esc":70,"mais85esc":60,"mais95esc":48,"mais105esc":40,"mais115esc":32,"mais125esc":24,
    ...
    "BL1": {"esc":9.8,"cartao":2.8,"fin":12.0,"chute_gol":5.5,"fal":24.5,"defesa_gk":3.2,"gols":3.1,
            ...
            "mais65esc":82,"mais75esc":74,"mais85esc":64,"mais95esc":52,"mais105esc":44,"mais115esc":36,"mais125esc":28,
    ...
    "DED": {"esc":10.5,"cartao":2.5,"fin":12.5,"chute_gol":5.8,"fal":22.5,"defesa_gk":3.0,"gols":3.2,
            "tiro_meta":3.5,"laterais":7.2,"imped":2.2,
            ...
            "mais65esc":85,"mais75esc":78,"mais85esc":68,"mais95esc":55,"mais105esc":48,"mais115esc":40,"mais125esc":32,
            "mais25imp":85,"mais35imp":70,
            "mais305lat":75,"mais325lat":62,"mais345lat":50,"mais365lat":38,
            "mais55tm":78,"mais65tm":66,"mais75tm":54,"mais95tm":36,
            "mais195fin":82,"mais205fin":76,"mais225fin":62,"mais255fin":42,
            "mais65cg":82,"mais75cg":70,"mais85cg":58,"mais95cg":62,
            "mais195fal":65,"mais225fal":50,"mais255fal":35,"mais295fal":20,
            "mais25def":68,"mais35def":45,"mais45def":30,"mais55def":15},
    ...
    "FL1": {"esc":8.5,"cartao":2.8,"fin":10.0,"chute_gol":4.3,"fal":24.0,"defesa_gk":3.9,"gols":2.7,
            ...
            "mais65esc":76,"mais75esc":68,"mais85esc":58,"mais95esc":46,"mais105esc":38,"mais115esc":30,"mais125esc":22,
    ...
    "ELC": {"esc":8.0,"cartao":3.5,"fin":9.2,"chute_gol":3.8,"fal":28.0,"defesa_gk":4.5,"gols":2.4,
            ...
            "mais65esc":70,"mais75esc":60,"mais85esc":48,"mais95esc":36,"mais105esc":28,"mais115esc":22,"mais125esc":18,
    ...
    "PPL": {"esc":8.8,"cartao":3.1,"fin":9.8,"chute_gol":4.1,"fal":26.0,"defesa_gk":4.1,"gols":2.5,
            ...
            "mais65esc":74,"mais75esc":64,"mais85esc":54,"mais95esc":42,"mais105esc":34,"mais115esc":26,"mais125esc":20,
    ...
    try:
        ...
        if not jogos:
            return {
                ...
                "mais35gols":med["mais35gols"],"menos35":med["menos35"],
                "mcartao":med["cartao"],"mais15cartao":med["mais15cartao"],
                "mais25cartao":med["mais25cartao"],"mais35cartao":med["mais35cartao"],
                "mais65cartao":med["mais65cartao"],
                "mesc":med["esc"],"mais65esc":med["mais65esc"],"mais75esc":med["mais75esc"],
                "mais85esc":med["mais85esc"],"mais95esc":med["mais95esc"],
                "mais105esc":med["mais105esc"],"mais115esc":med["mais115esc"],
                "mais125esc":med["mais125esc"],
                "mimped":med["imped"],"mais25imp":med["mais25imp"],"mais35imp":med["mais35imp"],
                "mlateral":med["laterais"],"mais305lat":med["mais305lat"],
                "mais325lat":med["mais325lat"],"mais345lat":med["mais345lat"],
                "mais365lat":med["mais365lat"],
                "mtiro":med["tiro_meta"],"mais55tm":med["mais55tm"],"mais65tm":med["mais65tm"],
                "mais75tm":med["mais75tm"],"mais95tm":med["mais95tm"],
                "mfin":med["fin"],"mais195fin":med["mais195fin"],"mais205fin":med["mais205fin"],
                "mais225fin":med["mais225fin"],"mais255fin":med["mais255fin"],
                "mchute":med["chute_gol"],"mais65cg":med["mais65cg"],"mais75cg":med["mais75cg"],
                "mais85cg":med["mais85cg"],"mais95cg":med["mais95cg"],
                "mfal":med["fal"],"mais195fal":med["mais195fal"],"mais225fal":med["mais225fal"],
                "mais255fal":med["mais255fal"],"mais295fal":med["mais295fal"],
                "mdefesa":med["defesa_gk"],"mais25def":med["mais25def"],"mais35def":med["mais35def"],
                "mais45def":med["mais45def"],"mais55def":med["mais55def"],
        ...
        def calc_menos(val): return round(100 - val*fator,0)
        
        return {
            "pV":pv,"pE":pe,"pD":pd,
            "mg":round(media_gols,1),
            "mais15":calc_mais(med["mais15"]),"menos15":calc_menos(med["mais15"]),
            "mais25":calc_mais(med["mais25"]),"menos25":calc_menos(med["mais25"]),
            "mais35gols":calc_mais(med["mais35gols"]),"menos35":calc_menos(med["mais35gols"]),
            ...
            "mais125esc":calc_mais(med["mais125esc"]),
        ...
        return {"pV":med["vit_casa"] if eh_casa else med["vit_fora"],"pE":med["empate"],"pD":med["vit_fora"] if eh_casa else med["vit_casa"],
                ...
                "mais25":med["mais25"],"menos25":med["menos25"],"mais35gols":med["mais35gols"],"menos35":med["menos35"],
                "mcartao":med["cartao"],"mais15cartao":med["mais15cartao"],"mais25cartao":med["mais25cartao"],"mais35cartao":med["mais35cartao"],"mais65cartao":med["mais65cartao"],
                "mesc":med["esc"],"mais65esc":med["mais65esc"],"mais75esc":med["mais75esc"],"mais85esc":med["mais85esc"],"mais95esc":med["mais95esc"],"mais105esc":med["mais105esc"],"mais115esc":med["mais115esc"],"mais125esc":med["mais125esc"],
                "mimped":med["imped"],"mais25imp":med["mais25imp"],"mais35imp":med["mais35imp"],
                "mlateral":med["laterais"],"mais305lat":med["mais305lat"],"mais325lat":med["mais325lat"],"mais345lat":med["mais345lat"],"mais365lat":med["mais365lat"],
                "mtiro":med["tiro_meta"],"mais55tm":med["mais55tm"],"mais65tm":med["mais65tm"],"mais75tm":med["mais75tm"],"mais95tm":med["mais95tm"],
                "mfin":med["fin"],"mais195fin":med["mais195fin"],"mais205fin":med["mais205fin"],"mais225fin":med["mais225fin"],"mais255fin":med["mais255fin"],
                "mchute":med["chute_gol"],"mais65cg":med["mais65cg"],"mais75cg":med["mais75cg"],"mais85cg":med["mais85cg"],"mais95cg":med["mais95cg"],
                "mfal":med["fal"],"mais195fal":med["mais195fal"],"mais225fal":med["mais225fal"],"mais255fal":med["mais255fal"],"mais295fal":med["mais295fal"],
                "mdefesa":med["defesa_gk"],"mais25def":med["mais25def"],"mais35def":med["mais35def"],"mais45def":med["mais45def"],"mais55def":med["mais55def"],
...
🔢 Mais 6.5: {m0(dc['mais65cartao'],df['mais65cartao'])}% | Menos 6.5: {menos(m0(dc['mais65cartao'],df['mais65cartao']))}%
 
📐 ESCANTEIOS:
📐 Média: {m(dc['mesc'],df['mesc'])}
🔢 Mais 6.5: {m0(dc['mais65esc'],df['mais65esc'])}% | Menos 6.5: {menos(m0(dc['mais65esc'],df['mais65esc']))}%
🔢 Mais 7.5: {m0(dc['mais75esc'],df['mais75esc'])}% | Menos 7.5: {menos(m0(dc['mais75esc'],df['mais75esc']))}%
🔢 Mais 8.5: {m0(dc['mais85esc'],df['mais85esc'])}% | Menos 8.5: {menos(m0(dc['mais85esc'],df['mais85esc']))}%
🔢 Mais 9.5: {m0(dc['mais95esc'],df['mais95esc'])}% | Menos 9.5: {menos(m0(dc['mais95esc'],df['mais95esc']))}%
🔢 Mais 10.5: {m0(dc['mais105esc'],df['mais105esc'])}% | Menos 10.5: {menos(m0(dc['mais105esc'],df['mais105esc']))}%
🔢 Mais 11.5: {m0(dc['mais115esc'],df['mais115esc'])}% | Menos 11.5: {menos(m0(dc['mais115esc'],df['mais115esc']))}%
🔢 Mais 12.5: {m0(dc['mais125esc'],df['mais125esc'])}% | Menos 12.5: {menos(m0(dc['mais125esc'],df['mais125esc']))}%
 
🚫 IMPEDIMENTOS:
🚫 Média Total: {m(dc['mimped'],df['mimped'])}
🔢 Mais 2.5: {m0(dc['mais25imp'],df['mais25imp'])}% | Menos 2.5: {menos(m0(dc['mais25imp'],df['mais25imp']))}%
🔢 Mais 3.5: {m0(dc['mais35imp'],df['mais35imp'])}% | Menos 3.5: {menos(m0(dc['mais35imp'],df['mais35imp']))}%
 
🧩 LATERAIS:
🧩 Média Total: {m(dc['mlateral'],df['mlateral'])}
🔢 Mais 30.5: {m0(dc['mais305lat'],df['mais305lat'])}% | Menos 30.5: {menos(m0(dc['mais305lat'],df['mais305lat']))}%
