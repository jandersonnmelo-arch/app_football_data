...
# ==============================
st.set_page_config(page_title="⚽ Análise Automática | Envio 07h Manaus", page_icon="🧠", layout="wide")
...
# 🧠 MEMÓRIA DA IA + CONTROLE DE ENVIO
...
def analise_ia(nome_casa, nome_fora, id_casa, id_fora, dc, df, dupla, liga_dados, confronto, gols_t):
    ...
    # Ajuste por histórico de acertos
...
MEDIAS_LIGA = {
    ...
    "MXL": {"nome":"Liga MX","esc":8.9,"cartao":3.3,"fin":9.3,"chute_gol":4.2,"fal":26.0,"defesa_gk":4.1,"gols":2.6,"gols_1t":1.1,"gols_2t":1.5,"juiz_tipo":"Equilibrado"},
...
LIGAS = {
    ...
    "🇫🇷 Ligue 1": "FL1", "🇮🇹 Série A Italiana": "SA", "🇲🇽 Liga MX": "MXL", "⚽ Brasileiro Feminino": "FBR",
    "🌍 Copa do Mundo Feminina": "FWORLD", "📋 Todas as Ligas": "TODAS"
}
...
# ==============================
# ⏰ ENVIO AUTOMÁTICO DIÁRIO 07h MANAUS
# ==============================
def executar_envio_automatico():
    ...
    if horario_atual == HORARIO_ALERTA and st.session_state.ultimo_envio_diario != hoje:
        ...
        st.success(f"✅ Envio automático concluído! {qtd_enviados} análises enviadas")
...
def dados_time(time_id, sigla, casa=False):
    ...
    if not jogos:
        return {"pV":m["gols"]*fc,"pE":25,"pD":m["gols"]*ff,"mg":m["gols"],"mg_1t":m["gols_1t"],"mg_2t":m["gols_2t"],"mcartao":m["cartao"],"mesc":m["esc"],"resumo":["📊 Liga"]*5,"placares":["Sem dados"]}
...
st.info(f"📅 Período: Ontem até 7 dias | Confiança ≥{LIMITE_CONFIANCA}%")
