...
# Opção de dias direto na tela
DIAS_BUSCA = st.number_input("Buscar quantos dias à frente?", min_value=1, max_value=14, value=7)

# ==============================
# MÉDIAS PARA TODAS AS LIGAS
# ==============================
MEDIAS_LIGA = {
    # BRASIL
...
# ==============================
# TODOS OS CAMPEONATOS DA IMAGEM
# ==============================
LIGAS = {
    "🌍 FIFA World Cup": "WC",
